...
{
    [Keyless]
    public partial class VwJmjm1DocNo
    {
        [Column("Job No")]
        [StringLength(30)]
        ...
        [Column("Air Waybill Bl No")]
        [StringLength(30)]
        public string? AirWaybillBlNo { get; set; }
        ...
        [Column("Master Air Waybill OBl No")]
        [StringLength(30)]
        public string? MasterAirWaybillOblNo { get; set; }
        ...
        [Column("Invoice Curr Rate", TypeName = "decimal(13, 6)")]
