...
{
    [Keyless]
    public partial class VwSmfq3StandardCharge
    {
        [Column("Trx No")]
        ...
        public int? QuoteCost01 { get; set; }
        [Column("Quote Cost 02")]
        public int? QuoteCost02 { get; set; }
        [Column("Quote Cost 03")]
        public int? QuoteCost03 { get; set; }
        [Column("Quote Cost 04")]
        public int? QuoteCost04 { get; set; }
        [Column("Quote Cost 05")]
        public int? QuoteCost05 { get; set; }
        [Column("Quote Cost 06")]
        public int? QuoteCost06 { get; set; }
        [Column("Quote Cost 07")]
        public int? QuoteCost07 { get; set; }
        [Column("Quote Cost 08")]
        public int? QuoteCost08 { get; set; }
        [Column("Quote Cost 09")]
        public int? QuoteCost09 { get; set; }
        [Column("Quote Cost 10")]
        public int? QuoteCost10 { get; set; }
        [Column("Quote Cost 11")]
        public int? QuoteCost11 { get; set; }
        [Column("Quote Cost 12")]
        public int? QuoteCost12 { get; set; }
        [Column("Quote Cost 13")]
        public int? QuoteCost13 { get; set; }
        [Column("Quote Cost 14")]
        public int? QuoteCost14 { get; set; }
        [Column("Quote Cost 15")]
        public int? QuoteCost15 { get; set; }
        [Column("Quote Cost 16")]
        public int? QuoteCost16 { get; set; }
