...
namespace SFDashboard.SFModels
{
    ...
    public partial class VwSibl1
    {
        ...
        [Column("Export Delivery Agent Name")]
        [StringLength(80)]
        public string? ExportDeliveryAgentName { get; set; }
        ...
        [Column("Export Master Job No")]
        [StringLength(30)]
        public string? ExportMasterJobNo { get; set; }
        [Column("Export Note")]
        [StringLength(255)]
        ...
        [Column("Total Freight Collect", TypeName = "decimal(38, 2)")]
        public decimal? TotalFreightCollect { get; set; }
        ...
        [Column("Total Rebate", TypeName = "decimal(38, 6)")]
        public decimal? TotalRebate { get; set; }
        [Column("Total Rebate By Master", TypeName = "decimal(38, 6)")]
        public decimal? TotalRebateByMaster { get; set; }
        [Column("Total Volume", TypeName = "decimal(13, 4)")]
        public decimal? TotalVolume { get; set; }
        [Column("Total Warehouse Charge", TypeName = "decimal(38, 2)")]
        public decimal? TotalWarehouseCharge { get; set; }
        [Column("Total Warehouse Charge By Master", TypeName = "decimal(38, 2)")]
        public decimal? TotalWarehouseChargeByMaster { get; set; }
