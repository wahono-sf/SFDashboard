...
namespace SFDashboard.SFModels
{
    ...
    public partial class Amid2
    {
        ...
        [InverseProperty("Amid2s")]
        public virtual Rchc1? AwbChargeCodeNavigation { get; set; }
        [ForeignKey("BusinessPartyCode")]
        [InverseProperty("Amid2s")]
        public virtual Amid1 BusinessPartyCodeNavigation { get; set; } = null!;
