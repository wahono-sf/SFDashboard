...
{
    [Keyless]
    public partial class VwSebl1NoCnDn
    {
        [Column("Trx No")]
        ...
        [Column("Ata Date (dd/mm/yyyy)")]
        [StringLength(10)]
        [Unicode(false)]
        public string? AtaDateDdMmYyyy { get; set; }
        ...
        [Column("Eta Dest Date")]
        [StringLength(10)]
        [Unicode(false)]
        public string? EtaDestDate { get; set; }
        [Column("Eta Pol (yyyy/mm/dd)")]
        [StringLength(10)]
        [Unicode(false)]
        public string? EtaPolYyyyMmDd { get; set; }
        [Column("Eta Pol Date")]
        [StringLength(10)]
        [Unicode(false)]
