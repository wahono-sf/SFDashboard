...
{
    [Keyless]
    public partial class VwImpm1Imgr1
    {
        [Column("Trx No")]
        ...
        [Column("GRN User Define 4")]
        [StringLength(50)]
        public string? GrnUserDefine4 { get; set; }
        [Column("GRN User Define 5")]
        [StringLength(50)]
        public string? GrnUserDefine5 { get; set; }
