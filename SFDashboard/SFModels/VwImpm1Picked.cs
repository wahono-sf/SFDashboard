...
{
    [Keyless]
    public partial class VwImpm1Picked
    {
        [Column("Trx No")]
        ...
        [Column("Completed Loose Qty")]
        public int? CompletedLooseQty { get; set; }
        ...
        [Column("Picked Loose Qty")]
        public int? PickedLooseQty { get; set; }
        [Column("Product Code")]
        [StringLength(255)]
