...
{
    [Table("siiv1")]
    [Index("ApplyToInvoice", Name = "IX_siiv1_1")]
    [Index("BlNo", Name = "IX_siiv1_2")]
    [Index("JobNo", "BillingPartyCode", "TrxType", Name = "IX_siiv1_3")]
    public partial class Siiv1
    {
        public Siiv1()
        {
            Siiv2s = new HashSet<Siiv2>();
        }
        ...
        public virtual ICollection<Siiv2> Siiv2s { get; set; }
    }
}
