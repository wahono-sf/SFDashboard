...
namespace SFDashboard.SFModels
{
    ...
    public partial class VwSibl21
    {
        ...
        [Column("Last Day Storage Date Time")]
        [StringLength(16)]
        [Unicode(false)]
        public string? LastDayStorageDateTime { get; set; }
        [Column("Mark No 01")]
        [StringLength(25)]
        ...
        [Column("Unstuffing Date")]
        [StringLength(16)]
        [Unicode(false)]
        public string? UnstuffingDate { get; set; }
        [Column("Uom Code")]
        [StringLength(50)]
