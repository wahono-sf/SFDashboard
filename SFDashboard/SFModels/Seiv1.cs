...
{
    [Table("seiv1")]
    [Index("ApplyToInvoice", Name = "IX_seiv1_1")]
    [Index("BlNo", Name = "IX_seiv1_2")]
    [Index("JobNo", "BillingPartyCode", "TrxType", Name = "IX_seiv1_3")]
    [Index("JobNo", Name = "IX_seiv1_4")]
    public partial class Seiv1
    {
        public Seiv1()
        {
            Seiv2s = new HashSet<Seiv2>();
        }
        ...
        public virtual ICollection<Seiv2> Seiv2s { get; set; }
    }
}
