...
namespace SFDashboard.SFModels
{
    ...
    public partial class VwAemp1
    {
        ...
        [Column("Actual Pickup dd-mm-yy")]
        [StringLength(16)]
        [Unicode(false)]
        public string? ActualPickupDdMmYy { get; set; }
        ...
        [Column("Pickup dd-mm-yy")]
        [StringLength(16)]
        [Unicode(false)]
        public string? PickupDdMmYy { get; set; }
        [Column("Pickup No")]
        [StringLength(15)]
