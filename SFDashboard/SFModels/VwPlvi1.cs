...
namespace SFDashboard.SFModels
{
    ...
    public partial class VwPlvi1
    {
        ...
        [Column("Cash Advance Type")]
        [StringLength(5)]
        public string? CashAdvanceType { get; set; }
        [Column("Cash Advance Vendor Code")]
        [StringLength(10)]
        public string? CashAdvanceVendorCode { get; set; }
        [Column("Cash Advance Vendor Name")]
        [StringLength(80)]
        public string? CashAdvanceVendorName { get; set; }
        ...
        [Column("Payment Amt", TypeName = "decimal(18, 2)")]
        ...
        [Column("Provision Reverse Flag")]
        [StringLength(1)]
        public string? ProvisionReverseFlag { get; set; }
        [Column("Purchase Doc Type")]
        [StringLength(2)]
        [Unicode(false)]
        public string? PurchaseDocType { get; set; }
        ...
        [Column("Sub Total Amt", TypeName = "decimal(18, 2)")]
        ...
        [Column("Total WHT Amt", TypeName = "decimal(13, 2)")]
        public decimal? TotalWhtAmt { get; set; }
        [Column("Total Zer Amt", TypeName = "decimal(17, 2)")]
