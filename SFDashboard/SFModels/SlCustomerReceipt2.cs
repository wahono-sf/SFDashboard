...
{
    [Keyless]
    public partial class SlCustomerReceipt2
    {
        [Column("Trx No")]
        ...
        [Column("Local Sub Total Amt", TypeName = "decimal(13, 2)")]
        ...
        [Column("Item Receipt Amt", TypeName = "decimal(13, 2)")]
        public decimal? ItemReceiptAmt { get; set; }
        [Column("Item Receipt Local Amt", TypeName = "decimal(13, 2)")]
        public decimal? ItemReceiptLocalAmt { get; set; }
