...
namespace SFDashboard.SFModels
{
    ...
    public partial class VwSebl1
    {
        ...
        [Column("Booking Customer Ref No")]
        [StringLength(50)]
        public string? BookingCustomerRefNo { get; set; }
        [Column("Booking No")]
        [StringLength(30)]
        public string? BookingNo { get; set; }
        [Column("Booking Shipper Name")]
        [StringLength(80)]
        public string? BookingShipperName { get; set; }
        ...
        [Column("Dg Flag")]
        [StringLength(1)]
        public string DgFlag { get; set; } = null!;
        ...
        [Column("Eta Date (dd/mm/yyyy)")]
        [StringLength(10)]
        [Unicode(false)]
        public string? EtaDateDdMmYyyy { get; set; }
        [Column("Eta Date Dest")]
        [StringLength(10)]
        [Unicode(false)]
        public string? EtaDateDest { get; set; }
        [Column("Eta Date POD")]
        [StringLength(10)]
        [Unicode(false)]
        public string? EtaDatePod { get; set; }
        [Column("Eta Date POL")]
        [StringLength(10)]
        [Unicode(false)]
        public string? EtaDatePol { get; set; }
        [Column("Eta Date SIN")]
        [StringLength(10)]
        [Unicode(false)]
        public string? EtaDateSin { get; set; }
        [Column("Eta POD")]
        [StringLength(10)]
        [Unicode(false)]
        ...
        [StringLength(10)]
        [Unicode(false)]
        public string? EtaSin { get; set; }
        [Column("Etd Date (dd/mm/yyyy)")]
        [StringLength(10)]
        [Unicode(false)]
        public string? EtdDateDdMmYyyy { get; set; }
        [Column("Etd Date POL")]
        [StringLength(10)]
        [Unicode(false)]
        public string? EtdDatePol { get; set; }
        [Column("Etd Date")]
        [StringLength(10)]
        [Unicode(false)]
        ...
        [Column("Master Create By")]
        [StringLength(50)]
        public string? MasterCreateBy { get; set; }
        ...
        [Column("No Of Booking")]
        public int? NoOfBooking { get; set; }
        [Column("No Of H Bl")]
        public int? NoOfHBl { get; set; }
        ...
        [Column("Said To Contain Flag")]
        [StringLength(1)]
        [Unicode(false)]
        public string SaidToContainFlag { get; set; } = null!;
        ...
        [Column("Schedule Port Of Discharge Name")]
        [StringLength(45)]
        public string? SchedulePortOfDischargeName { get; set; }
        [Column("Scn Code")]
        [StringLength(10)]
        ...
        [Column("Shipping Description Flag")]
        [StringLength(1)]
        [Unicode(false)]
        public string ShippingDescriptionFlag { get; set; } = null!;
        ...
        [StringLength(20)]
        public string? ShortBookingNo { get; set; }
        [Column("Short Container Seal No Type")]
        [StringLength(250)]
        public string? ShortContainerSealNoType { get; set; }
        [Column("Sign By")]
        [StringLength(50)]
        ...
        [Column("Sub House Consignee Name")]
        [StringLength(80)]
        public string? SubHouseConsigneeName { get; set; }
        [Column("Sub House Flag")]
        [StringLength(1)]
        [Unicode(false)]
        public string SubHouseFlag { get; set; } = null!;
        [Column("Submit Flag")]
        [StringLength(1)]
        ...
        [Column("Total Booking Gross Weight", TypeName = "decimal(38, 4)")]
        public decimal? TotalBookingGrossWeight { get; set; }
        [Column("Total Booking Pcs")]
        public int? TotalBookingPcs { get; set; }
        [Column("Total Booking Volume", TypeName = "decimal(38, 4)")]
        ...
        [StringLength(254)]
        public string TotalPcsInWord { get; set; } = null!;
        [Column("Total Pcs In Word Flag")]
        [StringLength(1)]
        [Unicode(false)]
        public string TotalPcsInWordFlag { get; set; } = null!;
        [Column("Total Volume", TypeName = "decimal(13, 4)")]
        public decimal? TotalVolume { get; set; }
        [Column("Total Warehouse1 Booking Volume", TypeName = "decimal(38, 4)")]
        public decimal? TotalWarehouse1BookingVolume { get; set; }
        [Column("Total Warehouse2 Booking Volume", TypeName = "decimal(38, 4)")]
        public decimal? TotalWarehouse2BookingVolume { get; set; }
        [StringLength(1)]
        [Unicode(false)]
