...
{
    [Keyless]
    public partial class PlAllPurchase2ImportJob
    {
        [Column("Trx No")]
        ...
        [StringLength(1)]
        [Unicode(false)]
        public string ItemUomCode { get; set; } = null!;
        ...
        [Column("Item Vat Local Amt", TypeName = "decimal(27, 8)")]
        ...
        [Column("Old Job No")]
        [StringLength(20)]
        public string OldJobNo { get; set; } = null!;
    }
}
