...
{
    [Table("sebk1")]
    [Index("AtaDate", Name = "INDEX_Sebk1_AtaDate")]
    [Index("BookingCustomerName", Name = "INDEX_Sebk1_BookingCustomerName")]
    [Index("BookingNo", Name = "INDEX_Sebk1_BookingNo")]
    [Index("EtdDate", Name = "INDEX_Sebk1_EtdDate")]
    [Index("ImportJobNo", Name = "INDEX_Sebk1_ImportJobNo")]
    [Index("JobNo", Name = "INDEX_Sebk1_JobNo")]
    [Index("JobType", Name = "INDEX_Sebk1_JobType")]
    [Index("MasterJobNo", Name = "INDEX_Sebk1_MasterJobNo")]
    [Index("PortOfDischargeCode", Name = "INDEX_Sebk1_PortOfDischargeCode")]
    [Index("StatusCode", Name = "INDEX_Sebk1_StatusCode")]
    [Index("UpdateDateTime", Name = "INDEX_Sebk1_UpdateDateTime")]
    [Index("WorkStation", Name = "INDEX_Sebk1_WorkStation")]
    [Index("UserGroup", Name = "IX_Sebk1_UserGroup_1")]
    [Index("BookingNo", Name = "Sebk1_BookingNo_UniqueCheck", IsUnique = true)]
    public partial class Sebk1
    {
        public Sebk1()
        {
            Sebk2s = new HashSet<Sebk2>();
            Sebk3s = new HashSet<Sebk3>();
            Sebk4s = new HashSet<Sebk4>();
            Sebk5s = new HashSet<Sebk5>();
        }
        ...
        [Column(TypeName = "datetime")]
        public DateTime? AvaDateTime { get; set; }
        [StringLength(50)]
        ...
        [Column(TypeName = "datetime")]
        public DateTime? StampingDateTime { get; set; }
        [StringLength(10)]
        ...
        [Column(TypeName = "datetime")]
        public DateTime? VentilationDateTime { get; set; }
        [StringLength(50)]
        ...
        [InverseProperty("TrxNoNavigation")]
        public virtual ICollection<Sebk4> Sebk4s { get; set; }
        [InverseProperty("TrxNoNavigation")]
        public virtual ICollection<Sebk5> Sebk5s { get; set; }
    }
}
