...
{
    [Keyless]
    public partial class JmJobProvisionWithDistributionCost
    {
        [Column("Job No")]
        [StringLength(20)]
        ...
        [Column("Cost Amt", TypeName = "decimal(38, 13)")]
        ...
        [Column("Cost Qty", TypeName = "decimal(38, 10)")]
        ...
        [Column("Cost Curr Rate", TypeName = "decimal(13, 6)")]
