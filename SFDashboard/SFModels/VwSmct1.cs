...
namespace SFDashboard.SFModels
{
    ...
    public partial class VwSmct1
    {
        ...
        [Column("Import Nomination Sales", TypeName = "decimal(13, 2)")]
        ...
        [StringLength(1)]
        [Unicode(false)]
        public string NoteFlag { get; set; } = null!;
        ...
        [Column("Port Of Discharge Terminal")]
        [StringLength(20)]
        ...
        [Column("Port Of Loading Terminal")]
        [StringLength(20)]
